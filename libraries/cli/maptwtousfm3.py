...
"""
This tool reads USFM files generated by csvtousfm3.py or osistousfm3.py
and injects tW links into the matching words.
...
if __name__ == '__main__':
    ...
    parser.add_argument('-o', '--output', dest='output', required=True,
                        help='Directory to which the updated USFM will be saved')
